...
const thePrompt = `
Quiero que me devuélvas únicamente un JSON con esta estructura trata siempre de dar una respueta a todos los cambos solo encasos ecepcionales colocalos vacios:
...
export async function POST(req: Request) {
    try {
        ...
        const esta = await geminiRequest(thePrompt + mesage);
